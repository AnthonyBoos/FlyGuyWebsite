...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p class="Content">
        Special Addition</p>
<p class="Content">&nbsp;&nbsp;&nbsp;&nbsp;Gamestation is proud to anounce that due to the global success of "FlyGuy" we have released "FlyGuy: The Special Edition". The special edition
     includes: more Levels, more Power-Ups, extended amount of lives, and your option to choose from different characters! The starting price for the game is $9.99. 
    Payment methods include PayPal, MasterCard, and pay-by-phone.
